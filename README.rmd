...
output:
    github_document
---
The MFtools library is used for investigating the input and output ffiles from MODFLOW simulations. 
...
The package includes a set of MODFLOW files from the Texas Water Development Board (TWDB) Groundwater Availability Model
(GAM) for the Edwards-Trinity (High Plains) Aquifer in Texas and New Mexico.
...
For the example using the TWDB GAM the rootname can be identified as 
follows (NOTE that by my personal convention my script headings include
